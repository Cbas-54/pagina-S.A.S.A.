        ...
        <div className="flex flex-col lg:flex-row items-center gap-20 lg:gap-32">
          ...
          >
            <div className="space-y-6">
              <h2 ref={titleRef} className="text-5xl md:text-7xl font-bold font-serif text-white tracking-tight leading-tight">
                La Síntesis de<br />
