...
const TopWaves = () => (
  <div className="absolute top-0 left-0 w-full z-[100] pointer-events-none translate-y-[-99.5%] overflow-visible">
    <svg viewBox="0 0 1440 320" preserveAspectRatio="none" className="absolute bottom-0 w-full h-[220px] fill-[#171717]/10">
    ...
    <svg viewBox="0 0 1440 320" preserveAspectRatio="none" className="absolute bottom-0 w-full h-[180px] fill-[#171717]/30">
    ...
    <svg viewBox="0 0 1440 320" preserveAspectRatio="none" className="absolute bottom-0 w-full h-[140px] fill-[#171717]">
...
const Stats = React.memo(() => {
  return (
    ...
    <section 
      id="stats" 
      className="relative z-20 pt-12 pb-8 px-6 bg-[#171717]"
