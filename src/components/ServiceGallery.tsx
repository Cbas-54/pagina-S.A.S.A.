...
const ECOSYSTEM_DATA = [
  {
    ...
    details: ["Check list profesional in-situ", "Evaluación profesional objetiva"],
  ...
  },
  {
    ...
    details: ["Lineamientos para brochure", "Estrategia para redes sociales", "Diferenciación en portales"],
...
const ServiceGallery = React.memo(() => {
  return (
    <section id="servicios" className="pt-12 pb-20 md:pt-20 md:pb-20 px-6 bg-[#F4F4F5] overflow-hidden">
