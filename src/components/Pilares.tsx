...
const PILARES_DATA = [
  {
    ...
    description: "Auditoría del sistema antisiniestral bajo estándares profesionales certificados.",
      ...
      <div className="max-w-7xl mx-auto relative z-30 px-6 pt-14">
        <div className="text-center mb-28">
          ...
          <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto italic font-light">
            Garantizamos transparencia profesional mediante tres dimensiones de rigor estructural.
          </p>
        </div>
