    ...
    <section id="equipo" className="relative pt-32 md:pt-48 pb-0 px-6 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 text-center">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/80">Liderazgo & Experiencia</span>
        </motion.div>
        ...
        >
          <span> Nos respaldan más de </span><span className="text-gold-seal italic font-light">15 AÑOS</span> de <br />
